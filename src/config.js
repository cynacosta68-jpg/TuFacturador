...
const config = {
  ...
  // Cookie de sesion Secure (solo viaja por HTTPS). INDEPENDIENTE del entorno de
  // ARCA: activala (ARCANUM_HTTPS=1) cuando la app este detras de HTTPS.
  secureCookie: /^(1|true|yes|on)$/i.test(process.env.ARCANUM_HTTPS || process.env.ARCANUM_SECURE_COOKIE || ''),
